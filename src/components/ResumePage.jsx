  ...
  return (
    <div className="p-8">
      {!submitted ? (
        ...
        //   </button>
        // </form>
//         <form onSubmit={handleSubmit} className="space-y-8 bg-white shadow-lg rounded-lg p-8 max-w-4xl mx-auto">
...
//         value={resumeData.name}
//         onChange={(e) => handleChange(e, null, "name")}
//         className="border rounded-lg focus:ring-2 focus:ring-teal-500 focus:outline-none p-3 w-full"
//         required
//       />
//     </div>
//     <div>
...
//           type="button"
//           onClick={() => addSubHeading(index)}
//           className="bg-green-500 hover:bg-green-600 text-white py-1 px-4 rounded-lg transition duration-300"
//         >
//           Add Subheading
//         </button>
//       </div>
...
//       type="button"
//       onClick={() => addMoreFields("skills")}
//       className="bg-blue-500 hover:bg-blue-600 text-white py-2 px-4 rounded-lg transition duration-300 mt-4"
//     >
//       Add More Skills
//     </button>
//   </div>
...
//   {/* Similar cool designs can be applied to Responsibilities, Achievements, Hobbies, and Projects */}
  
//   <button type="submit" className="bg-green-500 hover:bg-green-600 text-white py-3 px-6 rounded-lg transition duration-300">
//     Generate Resume
//   </button>
// </form>
